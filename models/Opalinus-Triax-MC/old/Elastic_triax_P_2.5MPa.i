# This test simulates an undrained consolidated UC triax test with a linear elastic Material
...
[Stages]
    ...
    [Stage1]
        ...
        t = 2.0
        constant_strain_z = '${units -5.0e-7 1/s -> ${modelunit_strain_rate} }'
