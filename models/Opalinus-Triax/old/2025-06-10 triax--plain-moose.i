...
#!include triax-in-one.p3d.groups.i
#!include triax.groups.i

boudaries = 'back bottom right top left front'
#boudaries = 'srfXMin srfXMax srfYMin srfYMax srfZMin srfZMax'
#boudaries = '${Mesh/BoundaryZMin} ${Mesh/BoundaryZMax} ${Mesh/MantleSurfaces}'
...
# ===== Initial Stress (given as effective stress) =====
[Functions]
  [ini_stress_xx]
    type = ParsedFunction
...
[Materials]
  [ini_stress]
    ...
    initial_stress = 'ini_stress_xx 0 0  0 ini_stress_yy 0  0 0 ini_stress_zz'
