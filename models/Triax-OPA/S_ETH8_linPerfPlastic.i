...
pconf = '${units 1000 kN/m^2 -> ${modelunit_pressure} }' #2.5 MPa --> the initial effective confining pressure applied to the sample before shearing
...
sample_h = '${units 0.124 m -> ${modelunit_length} }' #the initial height of the sample
...
[Mesh]
  ...
  [base]
    ...
    file = 'triax_0068x0124.p3d.e'
    show_info = false
  []
[]

!include triax_0068x0124.p3d.groups.i
...
[Functions]
  Water_Z_Ref = 0.124 #-> add pore pressure after confinement!
