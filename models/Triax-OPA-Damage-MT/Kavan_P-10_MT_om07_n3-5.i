...
pconf_total = 12.5
dip_angle = 90
damI = 1.5e-6 #(gemäss table 3 in K:\42202444 ENSI\2_Grundlagen\24_Fremd\2025-06-05 Aachen\ENSI Annual Research Report_KavanKhaledi.docx)
...
[Materials]
  ...
  [elasticity_tensor]
    ...
    youngs_modulus_in_plane = 2500 #MPa linear function of effective confining stress (see Khaledi et. al (2023) equation 27)
    youngs_modulus_normal = 1136.4
    poisson_ratio_in_plane = 0.15
    poisson_ratio_normal = 0.35
    shear_module_normal = 1500 #MPa
  ...
  [damage]
    ...
    omega = 0.7 #post peak model omega defined for Mont-Terri Opalinus
  ...
  [kavan]
    ...
    #hardening_a0 = 5e-6
    parameter_n0 = 3.5 #[2.5, 4.5] according to Khaledi et al (2023), describes the onset of dilation
